...
export default function Features(props) {
  ...
  const content = {
    ...
    'header-p2': 'Trained by Certified Trainers',
    ...
    'col2-header': 'CMS Website Development',
    ...
    'col3-header': 'Web Application Development',
    ...
    'col4-header': 'Mobile Application Development',
